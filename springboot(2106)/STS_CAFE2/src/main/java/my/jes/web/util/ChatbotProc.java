...
public class ChatbotProc {
  ...
  //public static String main(String voiceMessage, String apiURL, String secretKey) {
	  public static String request(String voiceMessage) {
        ...
        try {
            String apiURL = "https://13ced14121b04dcdb457272b850c04d2.apigw.ntruss.com/custom/v1/5032/1561c160cffd1b0bf774ca80914728adad746a724c1491a8a981cd2b63c71df1";
            ...
            String secretKey="aGJPbmNjTHFTZ0dQRUlTdEdWZ2lTeG9UcXlXcFhwUUE=";
